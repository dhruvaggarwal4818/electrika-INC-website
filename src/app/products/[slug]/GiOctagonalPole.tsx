...
export default function GiOctagonalPolePage() {
  ...
  const useCases = [
    { title: "Street & Road Lighting", desc: "Residential roads, colonies, internal township roads", icon: "🛣️" },
    { title: "Highway Service Lanes", desc: "Single and dual-arm lighting along service roads", icon: "🚗" },
    { title: "Parking Areas", desc: "Commercial and institutional parking lot illumination", icon: "🅿️" },
    { title: "Pathways & Promenades", desc: "Parks, riverside walks, pedestrian boulevards", icon: "🌳" },
    { title: "Industrial Estates", desc: "Internal road lighting within factories and logistics parks", icon: "🏭" },
    { title: "Smart City Projects", desc: "Standardised pole specification for municipal tenders", icon: "🏙️" }
  ];
