...
export default function LatchingMastPage() {
  ...
  const useCases = [
    { title: "Highway Mega-Junctions", desc: "High traffic interchanges where durability is critical", icon: "🛣️" },
    { title: "Airports", desc: "High-lux, zero-sway systems required for high-clearance aprons", icon: "✈️" },
    { title: "Ports & Container Terminals", desc: "Heavy-duty 24/7 operations lighting masts", icon: "⚓" },
    { title: "Government Flagship Projects", desc: "Prestige symbol installations demanding premium build quality", icon: "🏛️" },
    { title: "Large Stadiums", desc: "High-performance maintenance-free installations", icon: "🏟️" },
    { title: "Mining & Industrial Yards", desc: "Harsh environmental sites with extreme vibration", icon: "🏭" }
  ];
