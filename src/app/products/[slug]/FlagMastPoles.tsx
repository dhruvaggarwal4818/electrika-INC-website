...
export default function FlagMastPolesPage() {
  ...
  const useCases = [
    { title: "Government Buildings", desc: "Secretariats, panchayat offices, police headquarters", icon: "🏛️" },
    { title: "Airports & Ports", desc: "Landmark masts, national flag installations at gateways", icon: "✈️" },
    { title: "Smart Cities", desc: "City entrance poles, roundabout monuments, heritage squares", icon: "🌆" },
    { title: "Corporate Campuses", desc: "SEZs, IT parks, industrial headquarters, townships", icon: "🏢" },
    { title: "Sports Stadiums", desc: "Flag rows at stadiums, velodrome flagpoles", icon: "🏟️" },
    { title: "Border & Defence", desc: "BSF/CRPF posts, cantonment areas, national border monuments", icon: "🎖️" }
  ];
