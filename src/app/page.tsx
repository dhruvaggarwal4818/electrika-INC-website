    ...
    <div className={`${styles.pageWrapper} ${darkMode ? "dark-mode-active" : ""}`}>
      ...
      <main>
        ...
        <section className={styles.heroSection} aria-label="Hero Introduction">
          <Image
            src="/figma_assets/092f93b29d14b3858f67d3fa975a7018d513f549.png"
            ...
            <div className={styles.heroGrid}>
              ...
              <div className={styles.heroVisual}>
                <div className={styles.imageCard}>
                  <Image
                    src="/figma_assets/ba2e3bf5a8110d08facf5fd5d5df8115bcd5cfb1.png"
          ...
          <div className={styles.aboutWrapper}>
            <div className={styles.aboutGrid}>
              <div className={styles.aboutVisual}>
                <Image
                  src="/figma_assets/844f63bee97515bb5f94f62648c43b964528e7b2.png"
                  alt="Electrika INC installation project"
                  fill
